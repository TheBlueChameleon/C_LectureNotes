...
Im schlimmsten Fall überschreiben Sie Speicherbereiche, in dem ihr Code abgelegt ist und erzeugen so vollkommen chaotisches Verhalten. In den meisten Fällen stürzt Ihr Programm einfach ab (\emph{Segfault}).
